  ...
  <section class="py-16 bg-white text-right">
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="mb-8 flex justify-start">
        <a href="{{ route('home') }}#doctors" class="group inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 hover:bg-gray-100 hover:border-gray-300 text-gray-700 hover:text-gray-900 font-bold text-sm transition-all duration-300 shadow-sm cursor-pointer">
        ...
        @foreach($doctors as $index => $doc)
          ...
          >
            ...
            <div class="p-6 text-right">
              ...
              <p class="text-gray-400 text-xs mt-1">{{ $doc->department }}</p>
              ...
              <a
                href="{{ route('home') }}?dept={{ urlencode($doc->department) }}&doc={{ urlencode($doc->name) }}"
