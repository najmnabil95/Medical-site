    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in-up">
      <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div
          ...
          class="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-100 cursor-pointer"
        ...
        >
          ...
          <div class="p-6">
            ...
            <button
              onclick="event.stopPropagation(); prefillAppointment('<?php echo e($doc->department); ?>', '<?php echo e($doc->name); ?>')"
...
<?php /**PATH D:\laravel-hospital-website-development\resources\views/components/home/Doctors.blade.php ENDPATH**/ ?>