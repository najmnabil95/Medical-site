    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 animate-fade-in-up">
      <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $serv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        >
          ...
          <div class="relative">
            <div class="w-14 h-14 bg-gradient-to-br <?php echo e($color); ?> rounded-2xl flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
...
<?php /**PATH D:\laravel-hospital-website-development\hospital-backend\resources\views/components/home/Services.blade.php ENDPATH**/ ?>