...
<html lang="ar" dir="rtl">
  <head>
    ...
    <title>تسجيل الدخول - لوحة تحكم <?php echo e($settings->site_name ?? 'مستشفى الشفاء الدولي'); ?></title>
  ...
  <body class="min-h-screen bg-[#0f172a] antialiased text-gray-900">
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 via-primary-800 to-gray-900 p-4 relative overflow-hidden">
      ...
      <div class="w-full max-w-md relative">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center gap-3 mb-6">
            ...
            <div class="text-right">
              <h1 class="text-2xl font-bold text-white"><?php echo e($settings->site_name ?? 'مستشفى الشفاء'); ?></h1>
        ...
        <p class="text-center text-white/35 text-xs mt-6">© <?php echo e(date('Y')); ?> <?php echo e($settings->site_name ?? 'مستشفى الشفاء الدولي'); ?></p>
      </div>
    </div>
...
<?php /**PATH D:\laravel-hospital-website-development\resources\views/auth/login.blade.php ENDPATH**/ ?>