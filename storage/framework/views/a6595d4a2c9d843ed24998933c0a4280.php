          ...
          >
            ...
            <div class="p-6 text-right relative">
              ...
              <button
                ...
                class="mt-6 w-full bg-linear-to-l <?php echo e($gradient); ?> text-white py-3.5 rounded-xl font-bold text-sm hover:shadow-lg hover:shadow-primary-500/20 transition-all duration-300 flex items-center justify-center gap-2 opacity-95 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer"
              >
