      ...
      <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        >
          ...
          <div class="p-6">
            ...
            <button
              onclick="prefillAppointment('<?php echo e($doc->department); ?>', '<?php echo e($doc->name); ?>')"
...
<?php /**PATH D:\laravel-hospital-website-development\hospital-backend\resources\views/components/home/Doctors.blade.php ENDPATH**/ ?>