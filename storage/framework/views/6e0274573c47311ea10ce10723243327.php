  ...
  <div class="max-w-7xl mx-auto px-4 relative">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up">
      <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        >
          <!-- Hover background -->
          <div class="absolute inset-0 bg-gradient-to-br <?php echo e($reason['color']); ?> opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>

          <div class="relative">
            <div class="w-16 h-16 <?php echo e($reason['bg']); ?> group-hover:bg-white/20 rounded-2xl flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
              <i data-lucide="<?php echo e($reason['icon']); ?>" class="text-gray-700 group-hover:text-white transition-colors w-[30px] h-[30px]"></i>
            </div>
...
<?php /**PATH D:\laravel-hospital-website-development\hospital-backend\resources\views/components/home/WhyChooseUs.blade.php ENDPATH**/ ?>