...
<?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div id="dept-modal-<?php echo e($dept->id); ?>" class="hidden fixed inset-0 z-[9999] flex items-center justify-center p-4">
    
    <div class="fixed inset-0 bg-black/75" onclick="closeDeptModal(<?php echo e($dept->id); ?>)"></div>
