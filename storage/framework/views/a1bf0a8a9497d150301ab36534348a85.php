  ...
  <div class="max-w-7xl mx-auto px-4 relative">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 animate-fade-in-up">
      <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div
          onclick="openDeptModal(<?php echo e($dept->id); ?>)"
          class="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-gray-100 cursor-pointer relative overflow-hidden"
          style="animation-delay: <?php echo e($index * 80); ?>ms"
        >
          <!-- Hover background -->
          <div class="absolute inset-0 bg-gradient-to-br <?php echo e($deptColor); ?> opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div id="dept-modal-<?php echo e($dept->id); ?>" class="hidden fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div class="fixed inset-0 bg-black/70 backdrop-blur-sm" onclick="closeDeptModal(<?php echo e($dept->id); ?>)"></div>
          <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-scale-in">
            <!-- Header -->
            <div class="relative h-48 bg-gradient-to-br <?php echo e($deptColor); ?> overflow-hidden">
              ...
              <button
                onclick="closeDeptModal(<?php echo e($dept->id); ?>)"
            ...
            <div class="p-8 grid md:grid-cols-3 gap-8 text-gray-700">
              ...
              <div class="space-y-4">
                  ...
                  <div class="space-y-3">
                    <?php $__currentLoopData = $deptDoctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="bg-white rounded-2xl border border-gray-100 p-4 hover:shadow-md transition-all">
                        ...
                        <button
                          onclick="prefillAppointment('<?php echo e($dept->name); ?>', '<?php echo e($doc->name); ?>')"
                ...
                <button
                  onclick="prefillAppointment('<?php echo e($dept->name); ?>', '')"
...
<?php /**PATH D:\laravel-hospital-website-development\hospital-backend\resources\views/components/home/Departments.blade.php ENDPATH**/ ?>