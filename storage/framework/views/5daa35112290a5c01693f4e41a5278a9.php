      ...
      <div class="flex flex-col lg:flex-row gap-6 items-center justify-between">
        ...
        <div class="flex-1 w-full overflow-x-auto pb-2 lg:pb-0 scrollbar-hide" dir="rtl">
          <div class="flex items-center gap-3 w-max">
            ...
            <button onclick="filterByDepartment('<?php echo e($dept->name); ?>', this)" class="dept-filter-btn px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 bg-gray-50 text-gray-600 hover:bg-primary-50 hover:text-primary-600 border border-transparent hover:border-primary-100 whitespace-nowrap">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" id="doctors-cards-grid">
        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div
            ...
            data-name="<?php echo e(strtolower($doc->name)); ?>"
            data-specialty="<?php echo e(strtolower($doc->specialty)); ?>"
            data-department="<?php echo e(strtolower($doc->department)); ?>"
            ...
            <div class="p-6 text-right relative">
              ...
              <div class="flex items-center justify-between mt-5 pt-5 border-t border-gray-100 text-gray-700">
                <div class="text-center">
                  <div class="text-sm font-black text-gray-800"><?php echo e($doc->experience); ?></div>
                  <div class="text-xs text-gray-400 mt-0.5 font-medium">خبرة</div>
                </div>
                <div class="h-8 w-px bg-gray-200"></div>
                <div class="text-center">
                  <div class="text-sm font-black text-gray-800"><?php echo e($doc->patients); ?></div>
              ...
              <button
                type="button"
                onclick="if(typeof openBookingModal === 'function') openBookingModal('<?php echo e($doc->department); ?>', '<?php echo e($doc->name); ?>')"
                class="mt-6 w-full bg-gradient-to-l <?php echo e($gradient); ?> text-white py-3.5 rounded-xl font-bold text-sm hover:shadow-lg hover:shadow-primary-500/20 transition-all duration-300 flex items-center justify-center gap-2 opacity-95 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer"
              >
