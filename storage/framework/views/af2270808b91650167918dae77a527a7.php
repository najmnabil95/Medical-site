...
<?php if(!isset($modalDoctorsDataStored)): ?>
    <div id="info-modal-doctors-data" data-doctors='<?php echo e(json_encode($doctors)); ?>' class="hidden" aria-hidden="true"></div>
    <?php $modalDoctorsDataStored = true; ?>
<?php endif; ?>
...
<?php /**PATH D:\laravel-hospital-website-development\resources\views/components/doctor-info-modal.blade.php ENDPATH**/ ?>