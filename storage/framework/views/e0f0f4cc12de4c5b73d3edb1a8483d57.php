    ...
    <div class="relative" id="testimonials-carousel">
      <div class="overflow-hidden rounded-3xl">
        <div class="flex transition-transform duration-700 ease-in-out" id="testimonials-track">
          ...
          ?>
          <div class="w-full shrink-0 px-2 md:px-0" data-slide="<?php echo e($index); ?>">
            <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 max-w-3xl mx-auto">
              
              <div class="mb-6">
                <div class="w-14 h-14 bg-linear-to-br <?php echo e($color); ?> rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <div class="flex items-center gap-4">
                <div class="w-14 h-14 bg-linear-to-br <?php echo e($color); ?> rounded-2xl flex items-center justify-center text-white font-black text-lg shadow-md">
                  <?php echo e($testimonial->avatar ?? mb_substr($testimonial->name, 0, 1)); ?>

                </div>
                <div>
                  <h4 class="font-bold text-gray-900 text-base"><?php echo e($testimonial->name); ?></h4>
      ...
      <div class="flex items-center justify-center gap-2 mt-8">
        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <button
            ...
            class="testimonial-dot w-2.5 h-2.5 rounded-full transition-all duration-300 cursor-pointer <?php echo e($index === 0 ? 'bg-primary-500 w-8' : 'bg-gray-300 hover:bg-gray-400'); ?>"
...
<?php /**PATH D:\laravel-hospital-website-development\resources\views\components\home\Testimonials.blade.php ENDPATH**/ ?>