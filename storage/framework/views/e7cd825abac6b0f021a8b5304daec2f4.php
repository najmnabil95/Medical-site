<?php $__env->startSection('title', 'المقالات والأخبار - لوحة التحكم'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="news-grid">
    <?php $__empty_1 = true; $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      ...
      <div
        ...
        data-cat="<?php echo e($item->category); ?>"
      >
        ...
        <div>
          ...
          <div class="h-48 overflow-hidden bg-gray-50 relative">
            <img src="<?php echo e($item->image); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-full object-cover" onerror="this.src='https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=600&q=80'" />
          </div>

          <div class="p-5 text-right">
            <!-- Category Badge -->
            <span class="inline-flex px-2.5 py-0.5 rounded-full text-[10px] font-black border <?php echo e($badgeClass); ?> mb-3">
            ...
            <div class="flex items-center gap-3 justify-start text-[11px] text-gray-400 font-bold border-t border-gray-50 pt-3">
              ...
              <span class="flex items-center gap-1 font-mono">
                ...
                <span><?php echo e($item->date ? (\Carbon\Carbon::parse($item->date)->format('Y-m-d')) : ''); ?></span>
              </span>
              <span class="flex items-center gap-1 font-mono">
                <i data-lucide="clock" class="w-3.5 h-3.5"></i>
                <span><?php echo e($item->read_time); ?></span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="p-5 pt-0 text-right">
          <div class="flex items-center gap-2 pt-3 border-t border-gray-50">
            <button
              onclick="openEditModal(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->title)); ?>', '<?php echo e(addslashes($item->category)); ?>', '<?php echo e(addslashes($item->excerpt)); ?>', '<?php echo e(addslashes($item->content)); ?>', '<?php echo e($item->date ? \Carbon\Carbon::parse($item->date)->format('Y-m-d') : ''); ?>', '<?php echo e(addslashes($item->author)); ?>', '<?php echo e($item->read_time); ?>', '<?php echo e($item->category_color); ?>', <?php echo e($item->featured ? 'true' : 'false'); ?>)"
            ...
            <form action="<?php echo e(route('admin.news.destroy', $item->id)); ?>" method="POST" class="flex-1" onsubmit="return confirm('هل تريد حذف هذا المقال نهائياً؟');">
              <?php echo csrf_field(); ?>
  ...
  <div id="create-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-scale-in text-right">
      ...
      <form action="<?php echo e(route('admin.news.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-4 text-gray-700">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input type="date" name="date" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-primary-500" value="<?php echo e(date('Y-m-d')); ?>" />
          </div>
          <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel-hospital-website-development\hospital-backend\resources\views/admin/news/index.blade.php ENDPATH**/ ?>