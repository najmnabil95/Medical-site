  ...
  <div class="max-w-7xl mx-auto px-4 relative">
      ...
      <?php $__currentLoopData = $contactInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        >
          ...
          <?php $__currentLoopData = $info['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <p class="text-gray-500 text-sm leading-relaxed"><?php echo e($detail); ?></p>
    ...
    <div class="grid lg:grid-cols-2 gap-8">
      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 h-[550px] relative">
        <iframe
          src="<?php echo e(!empty($settings->map_link) ? $settings->map_link : 'https://maps.google.com/maps?q=' . urlencode(($settings->address ?? 'طريق الملك فهد') . ', ' . ($settings->city ?? 'الرياض')) . '&t=&z=15&ie=UTF8&iwloc=&output=embed'); ?>"
          width="100%"
          height="100%"
          style="border: 0;"
          allowfullscreen=""
        ...
        <div class="absolute bottom-6 right-6 bg-white rounded-2xl p-4 shadow-xl flex items-center gap-3">
          ...
          <div>
            <p class="font-bold text-gray-900 text-sm"><?php echo e($settings->site_name ?? 'مستشفى الشفاء'); ?></p>
            <p class="text-gray-500 text-xs"><?php echo e($settings->address ?? 'طريق الملك فهد'); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 relative">
        ...
        <div id="contact-form-container">
          ...
          <form id="contact-message-form" action="<?php echo e(route('messages.store')); ?>" method="POST" class="space-y-5" onsubmit="submitContactForm(event)">
            <?php echo csrf_field(); ?>
